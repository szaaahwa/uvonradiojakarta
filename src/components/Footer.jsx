...
const Footer = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#761F21] to-[#FB3748] w-full p-5 md:h-[400px] flex flex-col md:flex-row text-left gap-5">
      ...
      <div className="text-center flex-1">
        ...
        <br />
        <iframe
          className="w-[200px] md:w-[250px] h-[200px] md:h-[200px] rounded-md shadow-lg mx-auto"
